...
const HERO_IMAGE = 'https://media.db.com/images/public/69f4719cf7fe0120f3b8e695/c6ebcff13_generated_6930ba2f.png';
        ...
        >
          <div className="relative">
            ...
            <div className="glass-strong rounded-3xl p-3 shadow-2xl">
              <img
                src={HERO_IMAGE}
                alt="Abstract 3D glass shards floating in soft blue and lavender light"
